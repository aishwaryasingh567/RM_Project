...
<body>
    <div id="content">
        ...
        <a href="addevent_form.php" class="btn btn-primary" 
                                  ...
                                  onclick="window.open('addfood.php', 'newwindow', 'width=500,height=500'); return false;"><i
                                    class='fa fa-gg-circle' aria-hidden='true'></i></a>
                                
        <table width="100%" id="ssss" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <th style="width: 10%;">Food Id</th>
                        <th>Food Name</th>
                        <th>Food Description</th>
                        <th>Food price</th>
                        <th>Food Images</th>
                        <th>Edit your Food</th>
                    </tr>
                </thead>
                <tbody>
                    <?php while ($table = mysqli_fetch_object($food)) { ?>
                        <tr>
                            ...
                            <td>
                                <img src="food_image/<?= $table->image ?>" alt="">
                            </td>

                            <td>
                                <a href="#" class="btn btn-primary" title="Change Team Name"
                                    onclick="window.open('editfood.php?event_id=<?= $table->id ?>', 'newwindow', 'width=500,height=500'); return false;"><i
